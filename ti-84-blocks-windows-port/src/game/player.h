...
typedef struct player {
    ...
    void scroll_to_center(int32_t &goal_x, int32_t &goal_y) {
        int32_t screen_x = scroll_x + 160 + (16 * x) - (16 * z);
        int32_t screen_y = scroll_y + 209 -  (8 * x) -  (8 * z) - (16 * y);
    ...
    void scroll_to_contain(int32_t &goal_x, int32_t &goal_y) {
        int32_t screen_x = scroll_x + 160 + (16 * x) - (16 * z);
        int32_t screen_y = scroll_y + 209 -  (8 * x) -  (8 * z) - (16 * y);

        int32_t target_x = screen_x;
        int32_t target_y = screen_y;
